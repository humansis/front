...
export class English implements Language {
  ...
  commodity_modality_business_grant = 'Business Grant';
  commodity_modality_food = 'Food Rations';
  commodity_modality_wash = 'WASH Kit';
  commodity_modality_agriculture = 'Agricultural Kit';
  commodity_modality_rte = 'Ready to Eat Rations';
  commodity_modality_shelter = 'Shelter tool kit';
  commodity_modality_hygiene = 'Hygiene kit';
  commodity_modality_winterization = 'Winterization Kit';
  commodity_modality_dignity = 'Dignity kit';
  commodity_modality_activity = 'Activity item';
  commodity_modality_nfi = 'NFI Kit';
  commodity_kgs = 'Kgs';
  commodity_kit = 'Kit';
