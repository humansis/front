...
export class CountrySpecific extends CustomModel {
  ...
  public static apiToModel(countrySpecificFromApi: any): CountrySpecific {
    ...
    newCountrySpecific.set(
      'type',
      countrySpecificFromApi.type === 'text'
    ...
    newCountrySpecific.set(
      'countryIso3',
      countrySpecificFromApi.country_iso3 ? countrySpecificFromApi.country_iso3 : null
    );
    newCountrySpecific.set(
      'name',
      countrySpecificFromApi.field ? countrySpecificFromApi.field : null
    );
...
export class CountrySpecificAnswer extends CustomModel {
  ...
  public static apiToModel(countrySpecificAnswerFromApi: any): CountrySpecificAnswer {
    ...
    newCountrySpecificAnswer.set(
      'countrySpecific',
      CountrySpecific.apiToModel(countrySpecificAnswerFromApi.country_specific)
    );
