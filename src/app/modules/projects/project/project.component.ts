...
export class ProjectComponent implements OnInit, OnDestroy {
        ...
        if (response && response.length > 0) {
          ...
          if (
            ...
            this.projects.filter(
              (project: Project) => this.selectedProject.get('id') === project.get('id')
            ).length === 0
          ) {
  ...
  addDistribution() {
    this.router.navigate(['projects/add-distribution'], {
      queryParams: { project: this.selectedProject.get('id'), prefill: false },
    });
  }
  ...
  export() {
    ...
    this.distributionService
      .export('project', this.extensionType, this.selectedProject.get('id'))
      .subscribe(
        () => {
  ...
  exportOfficial() {
    ...
    this.distributionService
      .export(
        ...
        this.extensionOfficialType,
        this.selectedProject.get('id')
      )
      .subscribe(
        () => {
