...
import { HouseholdsDataSource } from 'src/app/models/data-sources/households-data-source';
...
export class BeneficiariesComponent implements OnInit, OnDestroy {
    ...
    if (this.selection.selected.length > 0) {
      ...
      filters = {
        ...
        sort: {
          ...
          direction:
            this.table.sort && this.table.sort.direction !== ''
  ...
  confirmAdding() {
    if (this.projectsList && this.dataSource) {
      ...
      this.projectService
        .addBeneficiaries(this.projectAddControl.value, benefForApi)
